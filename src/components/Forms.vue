<template>
    <div>
        ...
        <group title="">
            <x-input title="网关地址" novalidate placeholder="ip" v-model="info.ip1" @on-change="update" @on-blur="checkIp('ip1')" :icon-type="ip1"></x-input>
        </group>
        <group title="">
            <x-input title="管理中心地址" novalidate placeholder="ip" v-model="info.ip2" @on-change="update" @on-blur="checkIp('ip2')" :icon-type="ip2"></x-input>
        </group>
    </div>
</template>
